...
function defineMixins(app, instructions) {
  ...
  mixins.forEach(function(obj) {
    var exports = require(obj.sourceFile);
    var mixin = exports && exports.__esModule ? exports.default : exports;
  ...
  instructions.models.forEach(function(data) {
    ...
    if (!data.definition) {
      ...
      if (data.sourceFile) {
        ...
        var exports = require(data.sourceFile);
        var code = exports && exports.__esModule ? exports.default : exports;
...
function runScripts(app, list, callback) {
  ...
  list.forEach(function(filepath) {
    ...
    try {
      ...
      var bootFn = exports && exports.__esModule ? exports.default : exports;
...
function setupMiddleware(app, instructions) {
  ...
  middleware.forEach(function(data) {
    ...
    var exports = require(data.sourceFile);
    var factory = exports && exports.__esModule ? exports.default : exports;
    if (data.fragment) {
...
function setupComponents(app, instructions) {
  instructions.components.forEach(function(data) {
    ...
    var exports = require(data.sourceFile);
    var configFn = exports && exports.__esModule ? exports.default : exports;
    var opts = {
      useEnvVars: true,
    };
    data.config = getUpdatedConfigObject(app, data.config, opts);
